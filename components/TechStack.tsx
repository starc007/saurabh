        ...
        <CustomSection title="Tech Stack">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {TECH_STACK.map((skill, i) => (
                    <div key={i} className="flex items-center gap-2.5 group p-2 rounded-lg hover:bg-foreground/5 transition-colors border border-transparent hover:border-foreground/5">
